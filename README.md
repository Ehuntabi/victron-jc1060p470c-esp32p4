...
| **Ventilador frigo** | PWM LEDC en **GPIO 5** (JP1 pin 15), 18 kHz. El pin 15 ataca un MOSFET **IRLR7843** con resistencia en serie en puerta, resistencia de pull-down y diodo **1N4148** de rueda libre |
...
| **Fridge fan** | LEDC PWM on **GPIO 5** (JP1 pin 15), 18 kHz. Pin 15 drives an **IRLR7843** MOSFET with a series gate resistor, a pull-down resistor and a **1N4148** flyback diode |
