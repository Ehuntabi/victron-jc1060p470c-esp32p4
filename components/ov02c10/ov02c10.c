 ...
 static const esp_cam_sensor_isp_info_t ov02c10_isp_info[] = {
     {
         .isp_v1_info = {
             ...
             .vts = 1164,
             .hts = 2280,
             .tline_ns = 28636,   /* 1e9/(30*1164). FALTA en el PR: sin esto,
                                     esp_video calcula exposicion min/max = 0 y
                                     esp_ipa_agc se niega a arrancar. */
             .gain_def = 0x01,
             .exp_def = 0x46c,
     ...
     },
     {
         .isp_v1_info = {
            ...
            //  .pclk = 80000000,
             ...
             .vts = 2328,
             .hts = 1140,
             .tline_ns = 14316,   /* 1e9/(30*2328); ver nota de arriba */
             .gain_def = 0x01,
             .exp_def = 0x46c,
             .bayer_type = ESP_CAM_SENSOR_BAYER_GBRG,
         }
